...
class _CurrencyConverterMaterialPageState
  ...
  double result =
      0; // This variable is not used in the current code, but can be used for conversion logic later.
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: Text(
                "NGN ${result.toString()}", // Display the result of the conversion
            ...
            Padding(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  ...
                  prefixIcon: Icon(Icons.money_rounded, color: Colors.white),
